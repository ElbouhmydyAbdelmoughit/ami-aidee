...
/**
 * Created by save-favret on 04/02/2019.
 */



public class TrimVideoView extends ScalableVideoView implements
    ...
    public interface VideoViewListener {
        ...
        void onError();
        void onSeek(double currentPos, double seekTime);
    ...
    public VideoViewListener listener = null;
    ...
    public TrimVideoView(@NonNull Context context, AttributeSet attrs) {

        this(context, attrs, 0);
    }

    public TrimVideoView(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            public void run() {
                ...
                if (mMediaPlayerValid && !isCompleted && !mPaused && !mBackgroundPaused) {
                    ...
                    */
                    ...
                    if (listener != null)
                        listener.onSeek(getCurrentPosition(), mSeekTime);
                }
            }
        };
    }
   ...
   /* @Override
    ...
    public void setSrc(final String uriString, final String type, final boolean isNetwork, final boolean isAsset, final ReadableMap requestHeaders, final int expansionMainVersion, final int expansionPatchVersion) {
        ...
        try {
            if (isNetwork) {
                 ...
                 */
                setDataSource(getContext(), parsedUrl, headers);
            } else if (isAsset) {
                if ( uriString.startsWith("content://") || uriString.startsWith("file://") ) {
                    Uri parsedUrl = Uri.parse(uriString);
                    setDataSource(getContext(), parsedUrl);
                } else {
    ...
    public void setFullscreen(boolean isFullscreen) {
        ...
        Activity activity = null;//mThemedReactContext.getCurrentActivity();
        if (activity == null) {
            return;
        }
...
*/
       ...
       if (this.listener != null)
           this.listener.onPrepared(mVideoDuration / 1000.0);
    ...
    public void onSeekComplete(MediaPlayer mp) {
        ...
        if (this.listener != null)
            this.listener.onSeek(getCurrentPosition() / 1000.0, mSeekTime / 1000.0);
        mSeekTime = 0;
    }
