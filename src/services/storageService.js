...
export async function Save_Reminder_Service (reminder) {
  ...
  if( !reminderList ){
   ...
   try {
      ...
      // write the file
      if (values.imageURL != null && values.imageURL != undefined && values.imageURL != "") {
      ...
      if (values.videoUri != null && values.videoUri != undefined && values.videoUri != "") {
      ...
      values.videoUri =  Platform.OS === 'android' ? "file://" + videoPath : videoPath//
