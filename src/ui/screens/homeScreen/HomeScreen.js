...
import { Container, Header, View, Icon, Content, Form, Item, Input, Label, Button, Text, Body, Title, Card, CardItem, H1, Toast } from 'native-base';
 ...
 */
export default ({ awake, messagesRequest, list, loading, me, redirectFromSolarView }) => {
